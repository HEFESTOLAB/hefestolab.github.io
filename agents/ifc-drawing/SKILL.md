...
description: >
  ...
  dimensions, dimension chains, room areas and text, control IFC visibility,
  area-label visibility and colour, reconnect the source IFC, compose drawing
  sheets with movable view labels and area schedules,
